...
def main():
    ...
    window_size = 40
    dp = DataProcessor("data/data_test.csv", window_size=window_size, dt=0.11)
    ...
    # 2. В будущем: Тестируем GNN/Diffusion SLAM
    # print("\n=== Тестирование GNN/Diffusion SLAM ===")
    # nn_slam = NeuralDynamicSLAM(...)
    # evaluate_slam(nn_slam, dp, episode_id=0, num_epochs=100, plot_window_idx=5)
